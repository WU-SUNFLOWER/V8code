# 1 "../../src/trap-handler/handler-shared.cc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 413 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/trap-handler/handler-shared.cc" 2
# 20 "../../src/trap-handler/handler-shared.cc"
...
# 21 "../../src/trap-handler/handler-shared.cc" 2
